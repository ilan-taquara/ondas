...
const Membership = () => {
  ...
  const handleSubmit = (event) => {
    ...
    if (name.validate() && dateOfBirth.validate() && telephone.validate() && address.validate() && maritalStatus.validate()) {
      membershipService({
        name: name.value,
    ...
    <>
      ...
      <Input
        ...
        <Input
          ...
          {...whereAcceptedJesus}
        />
        <p>Você já foi batizado nas águas depois qque entregou a vida a Jesus ? </p>
        <InputRadio
          options={[
            { id: 1, name: 'Sim' },
            { id: 2, name: 'Não' },
